  ...
  return (
    <section className="grid flex-1 place-items-start pt-6 sm:pt-10">
      <div className="w-full rounded-[2.2rem] border border-slate-200/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.56),rgba(255,255,255,0.28))] p-4 shadow-[0_20px_60px_-42px_rgba(14,116,144,0.35)] backdrop-blur-sm dark:border-white/8 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] sm:p-5">
        <div className="mx-auto w-full max-w-2xl rounded-[1.5rem] border border-slate-200/80 bg-white/95 p-6 shadow-[0_26px_80px_-42px_rgba(15,23,42,0.24)] dark:border-white/10 dark:bg-slate-900/90 dark:shadow-[0_26px_80px_-42px_rgba(2,6,23,0.92)] sm:p-7">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="rounded-[1rem] border border-slate-200/80 bg-slate-50 px-4 py-3 text-right dark:border-white/10 dark:bg-slate-950/70">
          ...
          <p className="mt-5 max-w-xl text-sm leading-7 text-slate-600 dark:text-slate-300">
            ...
            starts, you will need to finish it before switching to another skill.
          </p>
          ...
          <div className="mt-4 rounded-[1rem] border border-slate-200/80 bg-slate-50/80 px-4 py-3 text-sm leading-6 text-slate-600 dark:border-white/10 dark:bg-slate-950/60 dark:text-slate-300">
